<template>
  <div
    class="bg-[url('/bg-compress.jpg')] pt-[80px] bg-cover bg-center rounded-[16px] min-[1440px]:h-[800px] lg:h-[700px] h-[600px] overflow-hidden px-5"
  >
    <div
    ...
    <div
      class="text-[22px] leading-[27px] text-center sm:mt-[48px] mt-[24px] max-w-[431px] mx-auto"
    >
      Built to make you extraordinarily productive, Cursor is the best way to
      code with AI.
    </div>
    <div class="flex sm:flex-row flex-col justify-center gap-[26px] mt-[35px]">
      <v-btn
        color="white"
      ...
      <v-btn
        ...
        :size="isMobile ? 'large' : 'x-large'"
        rounded="lg"
        class="uppercase !tracking-[0.56px] !leading-none bg-black"
